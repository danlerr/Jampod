                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12 col-md-9 d-flex flex-column">
                            <div class="card-body">
                                ...
                                {if $card_count > 0}
                                    {foreach from=$cards item=card}
                                        {if $card instanceof ECreditCard}
                                            <div class="payment-card d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                                                <div class="card-details d-flex flex-row align-items-center">
                                                    ...
                                                    <div class="card-info d-flex flex-column ms-3">
                                ...
                                <button class="btn btn-success mt-4" data-bs-toggle="modal" data-bs-target="#aggiungiModal">Aggiungi carta</button>

                                <!-- Aggiungi Carta Modal -->
